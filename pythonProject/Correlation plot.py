...
# select the columns you want to include in your model
X_cols = ['Age', 'RestingBP', 'Cholesterol', 'FastingBS', 'MaxHR', 'Oldpeak', 'ST_Slope', 'ChestPainType', 'ExerciseAngina', 'Sex']
X = df[X_cols]
y = df['HeartDisease']
...
# initialize and fit your linear regression model
model = LinearRegression()
model.fit(X_train, y_train)

# predict new values using your model
new_data = pd.DataFrame({'Age': [55],
                         'RestingBP': [130],
                         'Cholesterol': [250],
                         'FastingBS': [120],
                         'MaxHR': [145],
